...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Ivanov Oleg Arkadievich", Visual=0, Architecture=0, Networks=0, Calculate_Math=0, PI=0, Math=0, Electric=0},
                new Student{Name="Donov Yuri Andreevich", Visual=2, Architecture=2, Networks=2, Calculate_Math=2, PI=2, Math=2, Electric=2},
            };
            CheckAverage(students);
